...
function displayMonsters(){
    ...
    for (var key in monsters) {      
        ...
        var monsterDetail = '<div class="row"><div class="col-sm">'+monsterHPPB+'</div><div class="col-sm"> Atk : '+monsterAtk+' | Atk Speed : '+monsterAtkSpeed+'</div><div class="col-sm"></div></div>';
